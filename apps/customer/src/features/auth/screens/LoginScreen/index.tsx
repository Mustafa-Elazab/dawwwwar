...
export function LoginScreen() {
  ...
  const { t, control, handleSubmit, errors, isValid, isLoading, serverError, onSubmit, handleGoToRegister } = useController();
      ...
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity onPress={handleGoToRegister}>
            <Text style={styles.footerLink}>{t('auth.signup_btn')}</Text>
          </TouchableOpacity>
        </View>
      </View>
