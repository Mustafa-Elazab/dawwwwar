...
import { HomeScreen, SearchScreen, CategoryMerchantsScreen, MerchantDetailScreen, NotificationsScreen, LocationPickerScreen, NearbyMerchantsScreen, PopularProductsScreen } from '../placeholders';
